...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Location` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`User`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`User` (
  ...
  CONSTRAINT `fk_User_Location1`
    ...
    REFERENCES `chanter-prod`.`Location` (`LocationId`) ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Admin_Login`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Admin_Login` (
  ...
  CONSTRAINT `FKAdminLogin256912`
    FOREIGN KEY (`UserId`)
    REFERENCES `chanter-prod`.`User` (`UserId`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Effectif`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Effectif` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Groups`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Groups` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Role` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Choir`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Choir` (
  ...
  CONSTRAINT `FKChoir605558`
    ...
    REFERENCES `chanter-prod`.`Effectif` (`EffectifId`),
  CONSTRAINT `fk_Choir_Location1`
    FOREIGN KEY (`LocationId`)
    REFERENCES `chanter-prod`.`Location` (`LocationId`),
  CONSTRAINT `FKChoir_Grou123541`
	FOREIGN KEY (`GroupsId`)
	REFERENCES `chanter-prod`.`Groups` (`GroupsId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Choir_Committee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Choir_Committee` (
  ...
  CONSTRAINT `FKChoir_Comm363630`
    FOREIGN KEY (`RoleId`)
    REFERENCES `chanter-prod`.`Role` (`RoleId`),
  CONSTRAINT `FKChoir_Comm832697`
    FOREIGN KEY (`ChoirId`)
    REFERENCES `chanter-prod`.`Choir` (`ChoirId`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Menu` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Page`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Page` (
  ...
  CONSTRAINT `FKPage265487`
    FOREIGN KEY (`AdminId`)
    REFERENCES `chanter-prod`.`Admin_Login` (`AdminId`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Config`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Config` (
  ...
  CONSTRAINT `fk_Config_Menu1`
    ...
    REFERENCES `chanter-prod`.`Menu` (`idMenu`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Config_Page1`
    FOREIGN KEY (`HomePageId`)
    REFERENCES `chanter-prod`.`Page` (`PageId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Group_Committee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Group_Committee` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Loggin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Loggin` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Loggin_Choir`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Loggin_Choir` (
  ...
  CONSTRAINT `FKLoggin_Cho852253`
    ...
    REFERENCES `chanter-prod`.`Loggin` (`LogginId`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;


-- -----------------------------------------------------
-- Table `chanter-prod`.`Translations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Translations` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`Menu_has_Page`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`Menu_has_Page` (
  ...
  CONSTRAINT `fk_Menu_has_Page_Page1`
    ...
    REFERENCES `chanter-prod`.`Translations` (`idTranslation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`TypeChoir`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`TypeChoir` (
  ...
  CONSTRAINT `FKTypeChoir624557`
    ...
    REFERENCES `chanter-prod`.`TypeChoir` (`TypeChoirId`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;


-- -----------------------------------------------------
-- Table `chanter-prod`.`User_Choir`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`User_Choir` (
...
-- -----------------------------------------------------
-- Table `chanter-prod`.`User_Role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chanter-prod`.`User_Role` (
  `UserId` INT(10) NOT NULL,
  `RoleId` INT(10) NOT NULL,
...
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (6,7);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (8,9);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (10,11);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (12,13);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (14,15);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (16,17);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (18,19);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (20,21);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (22,23);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (24,25);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (26,27);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (28,29);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (30,31);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (32,33);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (34,35);
INSERT INTO `Translations` (`idFR`, `idDE`) VALUES (36,37);


COMMIT;

-- -----------------------------------------------------
-- Data for table `chanter-prod`.`Menu_has_Page`
-- -----------------------------------------------------
START TRANSACTION;
USE `chanter-prod`;
INSERT INTO `chanter-prod`.`Menu_has_Page` (`Menu_idMenu`, `Page_PageId`, `Order`) VALUES (1, 1, 0);

COMMIT;


-- -----------------------------------------------------
-- Data for table `chanter-prod`.`Config`
-- -----------------------------------------------------
START TRANSACTION;
USE `chanter-prod`;
INSERT INTO `chanter-prod`.`Config` (`idConfig`, `MainMenuId`, `HomePageId`) VALUES (1, 1, 1);
