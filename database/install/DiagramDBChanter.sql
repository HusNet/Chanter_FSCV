...
CREATE TABLE IF NOT EXISTS `chanter-dev`.`Menu_has_Page` (
  ...
  CONSTRAINT `fk_Menu_has_Page_Page1`
    ...
    REFERENCES `chanter-dev`.`Translations` (`idTranslation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
START TRANSACTION; USE `chanter-dev`;
INSERT INTO `chanter-dev`.`Page` (`PageId`, `Title`, `Content`, `Published_date`, `Updated_date`, `IsNews`, `AdminId`)VALUES (1, 'Page d\'accueil', '<h3>Bienvenue sur <a href="/" target="_blank">Chanter.ch</a></h3><p><br></p><p>La vie du monde choral en <strong>Valais</strong>!</p>', '2018-01-01 00:00:00', '2018-10-26 00:00:00', 0, 1);
INSERT INTO `chanter-dev`.`Page` (`PageId`, `Title`, `Content`, `Published_date`, `Updated_date`, `IsNews`, `AdminId`)VALUES (38, 'Startseite', '<h3>Willkommen bei <a href="Chanter.ch" target="_blank">Chanter.ch</a></h3><p><br></p><p><p><p>Das Leben der Chorwelt in <strong>Valais</strong>!</p>', '2018-10-26 00:00:00', '2018-10-26 00:00:00', 0, 1);
