...
INSERT INTO `chanter-dev`.`Page` (`PageId`, `Title`, `Content`, `Published_date`, `Updated_date`, `Lang`, `IdPageLang`, `IsNews`, `AdminId`)VALUES (1, 'Page d\'accueil', '<h3>Bienvenue sur <a href="/" target="_blank">Chanter.ch</a></h3><p><br></p><p>La vie du monde choral en <strong>Valais</strong>!</p>', '2018-01-01 00:00:00', '2018-10-26 00:00:00', 'fr', 38, 0, 1);
